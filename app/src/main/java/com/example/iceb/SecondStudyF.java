...
public class SecondStudyF extends Fragment {
    ...
    @SuppressLint("ValidFragment")
    public SecondStudyF(String section, int semester) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_second_study, container, false);
